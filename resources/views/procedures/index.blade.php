    ...
    @section('script')
        ...
        <script>
            function setEdit(data) {
                ...
                form.action = 'http://192.168.173.201/iseki_feed/public/procedure/tractor/update/' + data.Id_Tractor; // Sesuaikan route-mu
            ...
            function setDelete(data) {
                ...
                form.action =
                    `http://192.168.173.201/iseki_feed/public/procedure/tractor/delete/${data.Id_Tractor}`; // Sesuaikan dengan rute sebenarnya jika beda
            }
        </script>
    @endsection
