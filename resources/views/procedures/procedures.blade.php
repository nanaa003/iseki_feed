        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-primary"
                        href="{{ route('procedure') }}">Procedure</a></li>
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-primary"
                        href="{{ route('procedure.area.index', ['Name_Tractor' => $tractor]) }}">{{ $tractor }}</a>
                </li>
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                        href="{{ route('procedure.procedure.index', ['Name_Tractor' => $tractor, 'Name_Area' => $area]) }}">{{ $area }}</a>
                </li>
            </ol>
        </nav>
        <br>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="d-flex justify-content-center">
                                            <a href="#" class="text-primary text-xs mx-1" data-bs-toggle="modal"
                                                data-bs-target="#editModal" onclick="setEdit({{ $p }})">
                                                <i class="material-symbols-rounded">app_registration</i>
                                            </a>
                                            <a href="#" class="text-primary text-xs mx-1" data-bs-toggle="modal"
                                                data-bs-target="#uploadModal" onclick="setUpload({{ $p }})">
                                                <i class="material-symbols-rounded">upload_file</i>
                                            </a>
                                            <a href="#" class="text-primary text-xs mx-1" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" onclick="setDelete({{ $p }})">
