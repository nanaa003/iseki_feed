...
<body id="page-top" class="page-fade-in">
    ...
    <!-- Navigation-->
    <nav class="navbar navbar-premium-dark navbar-expand-lg fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">
                <i class="bi bi-broadcast me-2" style="color: #D4A853;"></i>ISEKI_FEED
            </a>
