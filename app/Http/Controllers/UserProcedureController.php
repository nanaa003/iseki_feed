...
class UserProcedureController extends Controller
{
    public function index(){
        ...
        return view('userprocedures.index', compact('page', 'tractors'));
    }
    ...
    public function create_tractor(Request $request)
    {
        ...
        return redirect()->route('userprocedure')->with('success', 'Tractor berhasil ditambahkan dan foto disimpan');
    }
    ...
    public function update_tractor(Request $request, string $Id_Tractor)
    {
        ...
        return redirect()->route('userprocedure')->with('success','Data dan folder berhasil diedit');
    }
    ...
    public function destroy_tractor($Id_Tractor)
    {
        ...
        return redirect()->route('userprocedure')->with('success','Data dan folder berhasil dihapus');
    }
    ...
    public function index_area($Name_Tractor){
        ...
        return view('userprocedures.areas', compact('page', 'tractor', 'photoTractor', 'areas'));
    }
    ...
    public function create_area(Request $request)
    {
        ...
        return redirect()
            ->route('userprocedure.area', ['Name_Tractor' => $Name_Tractor])
    ...
    public function update_area(Request $request, string $Id_Area)
    {
        ...
        return redirect()->route('userprocedure.area', ['Name_Tractor' => $newNameTractor])
    ...
    public function destroy_area($Id_Area)
    {
        ...
        return redirect()->route('userprocedure.area', ['Name_Tractor' => $Name_Tractor])
    ...
    public function create_procedure(Request $request)
    {
        ...
        return redirect()->route('userprocedure.procedure', [
            'Name_Tractor' => $tractor,
            'Name_Area' => $area
    ...
    public function update_procedure(Request $request, string $Id_Procedure)
    {
        ...
        return redirect()->route('userprocedure.procedure', ['Name_Tractor' => $newNameTractor, 'Name_Area' => $newNameArea])
